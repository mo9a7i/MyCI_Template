	...
	function login()
	{
		...
		{ //check to see if the user is logging in
			...
			{ //if the login is successful
				...
				//Mods By Mohannad, if the user is not active, log him off
				...
				{	
					//if the user is not active yet
					$this->ion_auth->logout();
					$this->session->set_flashdata('error', 'عضويتك بإنتظار تفعيل الإدارة, سيتم إرسال رسالة بريدية إليك قريباً!');
					redirect($this->agent->referrer(), 'refresh');
