...
*/
	 ...
	 */
	$config['site_title']		   = "F6sny.com";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "mohannad.otaibi@gmail.com";
	 ...
	 **/
	$config['message_start_delimiter'] = '<div class="alert"><a class="close" data-dismiss="alert">×</a><h4 class="alert-heading">رسالة!</h4>';
	 ...
	 **/
	$config['error_start_delimiter'] = '<div class="alert alert-error"><a class="close" data-dismiss="alert">×</a><h4 class="alert-heading">خطأ!</h4>';
