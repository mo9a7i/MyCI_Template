...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="<?=base_url()?>admin/users/deleted"><i class="icon-trash"></i> المحذوفين</a></li>
...
<tbody>
	...
	<?php $this->load->view('admin/users/users_table_rows_deleted.php'); ?>					
