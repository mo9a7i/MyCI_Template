...
<div class="page-header">	
	<h1>النكت</h1>
	<p>قائمة النكت بالإنتظار</p>
</div>
<ul class="nav nav-tabs">
	<li><a href="<?=base_url()?>admin/posts"><i class="icon-th-list"></i> القائمة</a></li>
	<li class="active"><a href="#"> <i class="icon-time"></i> بالإنتظار</a></li>
	<li><a href="<?=base_url()?>admin/posts/deleted"> <i class="icon-trash"></i> الممسوحة</a></li>
